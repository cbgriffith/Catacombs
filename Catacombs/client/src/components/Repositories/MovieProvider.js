...
export const MovieProvider = (props) => {
    ...
    const getMoviesByRating2 = () => {
        return fetch(`https://api.themoviedb.org/3/movie/top_rated?api_key=b90c6e98b6940ecc7131589bc7ed9067&language=en-US&with_genres=27&with_original_language=en&page=2`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    //fetch horror movies by rating, page 3
    const getMoviesByRating3 = () => {
        return fetch(`https://api.themoviedb.org/3/movie/top_rated?api_key=b90c6e98b6940ecc7131589bc7ed9067&language=en-US&with_genres=27&with_original_language=en&page=3`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    //fetch horror movies by rating, page 4
    const getMoviesByRating4 = () => {
        return fetch(`https://api.themoviedb.org/3/movie/top_rated?api_key=b90c6e98b6940ecc7131589bc7ed9067&language=en-US&with_genres=27&with_original_language=en&page=4`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    //fetch horror movies by rating, page 5
    const getMoviesByRating5 = () => {
        return fetch(`https://api.themoviedb.org/3/movie/top_rated?api_key=b90c6e98b6940ecc7131589bc7ed9067&language=en-US&with_genres=27&with_original_language=en&page=5`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    ...
    const searchMovies = (query) => {
        return fetch(`https://api.themoviedb.org/3/search/movie?api_key=b90c6e98b6940ecc7131589bc7ed9067&language=en-US&query=${query}&page=1&include_adult=false`)
            .then((res) => res.json())
            .then(setMovies);
    };
    ...
    const comingSoon = () => {
        return fetch(`https://api.themoviedb.org/3/movie/upcoming?api_key=b90c6e98b6940ecc7131589bc7ed9067&with_genres=27&language=en-US&page=1`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    ...
    const nowPlaying = () => {
        return fetch(`https://api.themoviedb.org/3/movie/now_playing?api_key=b90c6e98b6940ecc7131589bc7ed9067&with_genres=27&language=en-US&page=1`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    ...
    const popularMovies = () => {
        return fetch(`https://api.themoviedb.org/3/movie/popular?api_key=b90c6e98b6940ecc7131589bc7ed9067&with_genres=27&language=en-US&page=1`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    //fetch horror movies and rank them by popularity score, page 2
    const popularMovies2 = () => {
        return fetch(`https://api.themoviedb.org/3/movie/popular?api_key=b90c6e98b6940ecc7131589bc7ed9067&with_genres=27&language=en-US&page=2`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    //fetch horror movies and rank them by popularity score, page 3
    const popularMovies3 = () => {
        return fetch(`https://api.themoviedb.org/3/movie/popular?api_key=b90c6e98b6940ecc7131589bc7ed9067&with_genres=27&language=en-US&page=3`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    //fetch horror movies and rank them by popularity score, page 4
    const popularMovies4 = () => {
        return fetch(`https://api.themoviedb.org/3/movie/popular?api_key=b90c6e98b6940ecc7131589bc7ed9067&with_genres=27&language=en-US&page=4`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    //fetch horror movies and rank them by popularity score, page 5
    const popularMovies5 = () => {
        return fetch(`https://api.themoviedb.org/3/movie/popular?api_key=b90c6e98b6940ecc7131589bc7ed9067&with_genres=27&language=en-US&page=5`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
    ...
    const recommendedMovies = (movieId) => {
        return fetch(`https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=b90c6e98b6940ecc7131589bc7ed9067&language=en-US&page=1`)
            .then(res => res.json())
            .then(movieObject => setMovies(movieObject.results))
    }
